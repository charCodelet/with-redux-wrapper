                        ...
                        function(event) {
                            ...
                            if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                                var editor = this.editor,
                                    contentEditableParent = new CKEDITOR.dom.elementPath(
                                        domEvent.getTarget(),
                                        editor.editable()
                                ...
                                if (
                                    ...
                                    contentEditableParent.getAttribute('contenteditable') ==
                                    'false'
                                )
                            ...
                            CKEDITOR.tools.setTimeout(
                                function() {
                                    const item = this.items.map(item => {
                                        if (
                                            item.name === 'paste' &&
                                            CKEDITOR.currentInstance.newBlock
                                        ) {
                                            item.className =
                                                'cke_menubutton__paste cke_menubutton__disabled';
