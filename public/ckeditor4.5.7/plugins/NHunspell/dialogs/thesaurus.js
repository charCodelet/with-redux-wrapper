...
CKEDITOR.dialog.add(NHUNSPELL_COMMAND_THESAURUS, function (editor) {
    ...
    return {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                setupButtonState: function () {
                                    ...
                                    var prevBtn = dialog.getContentElement('thesaurus', 'prev');
                                    var lookedUp = dialog.getContentElement('thesaurus', 'lookedUp');
                                    if (CKEDITOR.plugins.NHunspell.lookupHistory.length > 0 &&
                                         lookedUp.getValue() !== CKEDITOR.plugins.NHunspell.lookupHistory[0]) {
                                        prevBtn.enable();
                                    } else {
                                        prevBtn.disable();
                                    }
        ...
        onShow: function () {
            ...
            var currentRange = this.getParentEditor().createRange(), startNode = "", textNode = "", bookmark = "";

            if (this.getParentEditor().getSelection().getRanges()[0].startContainer.$
                .nodeType ===
                CKEDITOR.NODE_ELEMENT) {
                if ((this.getParentEditor().getSelection().getRanges()[0].startContainer.$.parentNode.childNodes[0]
                            .nodeType ===
                            CKEDITOR.NODE_TEXT) &&
                        !!(this.getParentEditor().getSelection().getRanges()[0].startContainer.$.parentNode
                            .childNodes[1])
                ) {
                    currentRange = this.getParentEditor().getSelection().getRanges();
                    if (currentRange[0].startContainer.$.nodeType ===
                        CKEDITOR.NODE_ELEMENT) {
                ...
                } else if ((this.getParentEditor().getSelection().getRanges()[0].startContainer.$.childNodes[0]
                            .nodeType ===
                            CKEDITOR.NODE_TEXT) &&
                        !!(this.getParentEditor().getSelection().getRanges()[0].startContainer.$.childNodes[1])
                ) {
                    bookmark = this.getParentEditor().getSelection().getRanges()[0].startContainer.$.childNodes[0]
                        .length;

                    this.getParentEditor().getSelection().getRanges()[0].startContainer.$
                        .textContent = this.getParentEditor().getSelection().getRanges()[0].startContainer.$
                        .textContent;

                    startNode = this.getParentEditor().getSelection().getRanges()[0].startContainer;
            ...
            if (!(currentRange.startContainer === null && currentRange.endContainer === null) && (this.getParentEditor().getSelection().getSelectedText().length===0)) {
            ...
            this.setupContent($.trim(this.getParentEditor().getSelection().getSelectedText()));
            var dialog = CKEDITOR.dialog.getCurrent();
