...
( function() {
	...
	function loadTheme( editor ) {
		...
		var container = CKEDITOR.dom.element.createFromHtml( themedTpl.output( {
			...
			topHtml: topHtml ? '<span id="' + editor.ui.spaceId('top') + '" class="cke_top cke_reset_all" role="presentation" style="height:auto" onclick=" CKEDITOR.topClickHandler()">' + topHtml + '</span>' : '',
