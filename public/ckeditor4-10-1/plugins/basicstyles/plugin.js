...
/**
 *  TODO, context menu listener to contextmenu plugin
 *   ENAEP has updated this plugin from base ckeditor.   MODIFIED PLUGIN
 *    see  line 22, 56  If the "menu" plugin is loaded, register the menu item.
 *    see  line111 - context menu listener for bold,itlaic,underline state change
 */
  ...
  init: function(editor) {
    ...
    if (editor.contextMenu) {
      editor.contextMenu.addListener(function(element, selection) {
        ...
        // by checking if the selection is bold/italic/underlined, etc. and returning tristate_on if so. However, AFAIK
        // that is not in the requirements (RM 5/29/15)
        return {
          bold: CKEDITOR.TRISTATE_OFF,
          italic: CKEDITOR.TRISTATE_OFF,
          underline: CKEDITOR.TRISTATE_OFF
        };
      });
    }

    editor.setKeystroke([[CKEDITOR.CTRL + 66 /*B*/, 'bold'], [CKEDITOR.CTRL + 73 /*I*/, 'italic'], [CKEDITOR.CTRL + 85 /*U*/, 'underline']]);
  }
});
