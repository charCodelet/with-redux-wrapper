 ...
 *     see line 92  - uiButtonCommand for custom logging
 *         line 170 - Ron Morrill: added code to prevent setting focus to disabled button
 *         line 345 - dealing with Paste state
 *
 */
...
(function() {
  ...
  CKEDITOR.plugins.add('button', {
    ...
    lang:
      'af,ar,az,bg,ca,cs,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,eu,fa,fi,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,tr,tt,ug,uk,vi,zh,zh-cn', // %REMOVE_LINE_CORE%
    ...
    CKEDITOR.tools.extend(
      ...
      // Set defaults.
      {
        ...
        click:
          definition.click ||
          function(editor) {
            // garyfeng: raise custom event for keystroke logging
            editor.fire('uiButtonCommand', definition);
            // end garyfeng
  ...
  CKEDITOR.ui.button.prototype = {
    ...
    render: function(editor, output) {
      ...
      var instance = {
        ...
        focus: function() {
          ...
          // Ron Morrill: added code to prevent setting focus to disabled button
          if (element.$.className.indexOf('cke_button_disabled') >= 0) {
            return false;
          }
          element.focus();
          return true;
    ...
    setState: function(state) {
      ...
      if (CKEDITOR.currentInstance && CKEDITOR.currentInstance.newBlock && this.command === 'paste') {
        // Paste begins in the disabled state
