...
(function() {
          ...
          '20': {
            refresh: function(editor, path) {
              ...
              if (!this.enterBr && !this.getContext(path)) return TRISTATE_DISABLED;
                ...
                if (indentClassLeft.call(this, firstBlock, classes)) return TRISTATE_OFF;
                ...
                if (this.isIndent) {
                  return getIndent(firstBlock) > editor.config.indentMax ? TRISTATE_DISABLED : TRISTATE_OFF;
                }
                ...
                //		try to increase/decrease it.
                  ...
                  return CKEDITOR[(getIndent(firstBlock) || 0) <= 0 ? 'TRISTATE_DISABLED' : 'TRISTATE_OFF'];
                }
              }
            },
            ...
            exec: function(editor) {
              ...
              // paragraphs in the range, creating them if necessary.
                ...
                while ((block = iterator.getNextParagraph(enterMode == CKEDITOR.ENTER_P ? 'p' : 'div'))) {
                  if (!block.isReadOnly()) indentElement.call(this, block, classes);
                }
              }
  ...
  function indentElement(element, classes, dir) {
    if (element.getCustomData('indent_processed')) return;
