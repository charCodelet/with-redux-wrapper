/**
 * fontsizes: eNAEP custom plugin.  Will need to be ported to any new version of CKEDITOR */
      ...
      editor.attachStyleStateChange(style, function(state) {
        if (!editor.readOnly) {
          if (commandName === 'SmallFont') {
            var smallState =
              mediumStyle.checkActive(editor.elementPath(), editor) || largeStyle.checkActive(editor.elementPath(), editor) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_ON;
